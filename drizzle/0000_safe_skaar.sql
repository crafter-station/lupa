...
CREATE UNIQUE INDEX "deployment_project_environment_unique" ON "deployment" USING btree ("project_id","environment") WHERE "deployment"."environment" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "deployment_project_env_status_idx" ON "deployment" USING btree ("project_id","environment","status");