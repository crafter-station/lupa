...
(async () => {
  ...
  const options = {
    method: "POST",
    headers: {
      Authorization: "Bearer fc-1e634e38e9604b83b0db00b359702e77",
  ...
  try {
    ...
    const result = streamText({
      ...
      prompt: `You are tasked with improving markdown content by cross-referencing it with the extracted text from the original HTML page.
