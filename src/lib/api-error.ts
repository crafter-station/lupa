...
export const ErrorCode = {
  ...
  DEPLOYMENT_NOT_STAGING: "DEPLOYMENT_NOT_STAGING",
  ...
  INSUFFICIENT_API_KEY_PERMISSIONS: "INSUFFICIENT_API_KEY_PERMISSIONS",
  INVALID_ENVIRONMENT_TRANSITION: "INVALID_ENVIRONMENT_TRANSITION",
} as const;
